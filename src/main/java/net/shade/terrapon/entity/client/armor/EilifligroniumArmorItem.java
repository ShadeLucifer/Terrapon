...
public class EilifligroniumArmorItem extends ArmorItem implements GeoItem {
    ...
    public EilifligroniumArmorItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    private void addEffectToPlayer(Player player, MobEffectInstance mapEffect) {
        ...
        if(!hasPlayerEffect) {
            ...
            player.addEffect(new MobEffectInstance(TerraponEffects.THOREK_BOOST_EFFECT.get(), 10, 10));
            player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 10, 10));
    ...
    public void inventoryTick(ItemStack pStack, Level pLevel, Entity pEntity, int pSlotId, boolean pIsSelected) {
        if (pEntity instanceof Player player) {
            ...
            if (boots.getItem() instanceof EilifligroniumArmorItem && leggings.getItem() instanceof EilifligroniumArmorItem && chestplate.getItem()
                    instanceof EilifligroniumArmorItem && helmet.getItem() instanceof EilifligroniumArmorItem) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private EilifligroniumArmorRenderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new EilifligroniumArmorRenderer();
